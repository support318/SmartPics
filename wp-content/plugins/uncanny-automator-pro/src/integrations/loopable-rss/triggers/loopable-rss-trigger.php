...
namespace Uncanny_Automator_Pro\Integrations\Loopable_Rss\Triggers;

use Uncanny_Automator\Automator_Status;
use Uncanny_Automator_Pro\Integrations\Loopable_Rss\Helpers\Loopable_Rss_Helpers;
use Uncanny_Automator_Pro\Integrations\Loopable_Rss\Tokens\Loopable\Trigger\Rss_Items;
...
/**
 *
 * Loopable_Rss_Trigger
 *
 * @package Uncanny_Automator\Integrations\Loopable_Rss\Triggers
 *
 */
class Loopable_Rss_Trigger extends \Uncanny_Automator\Recipe\Trigger {
	...
	protected function setup_trigger() {
		...
		$this->set_trigger_code( 'TRIGGER_LOOPABLE_RSS_CODE' );
		$this->set_trigger_meta( 'TRIGGER_LOOPABLE_RSS_META' );
		...
		$this->set_loopable_tokens(
			array(
				'TRIGGER_LOOPABLE_RSS_ITEMS' => Rss_Items::class,
			)
		);
	...
	public function register_hooks() {
		...
		$closure = function ( $item, $recipe_id ) {
			...
			if ( 'TRIGGER_LOOPABLE_RSS_META' !== $requesting_meta ) {
				return;
			}
			...
			$config = array(
				'loopable_id' => 'TRIGGER_LOOPABLE_RSS_ITEMS',
				'type'        => 'TRIGGER_TOKEN',
	...
	public function options() {
		return Loopable_Rss_Helpers::make_fields( $this->get_trigger_meta() );
	}
