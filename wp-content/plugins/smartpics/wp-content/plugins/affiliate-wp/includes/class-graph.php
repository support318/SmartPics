...
class Affiliate_WP_Graph {
	...
	*/
	...
	public function load_scripts() {
		...
		wp_enqueue_script( 'jquery-flot', AFFILIATEWP_PLUGIN_URL . 'assets/js/vendor/jquery-flot/jquery.flot' . $suffix . '.js', array( 'jquery' ) );

		if( $this->load_resize_script() ) {
			wp_enqueue_script( 'jquery-flot-resize', AFFILIATEWP_PLUGIN_URL . 'assets/js/vendor/jquery-flot/jquery.flot.resize' . $suffix . '.js', array( 'jquery' ) );
		}
	}
