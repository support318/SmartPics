...
// @TODO When updating, change wp_remote_post() to wp_remote_get()
// and update to if ( is_object( $_data ) && ! isset( $_data->plugin ) ) {.
...
class WPF_Plugin_Updater {
	...
	/**
	 * Updates information on the "View version 3.44.24 details" page with custom data.
	 *
	 * @uses api_request()
	 *
	 * @param mixed  $_data
	...
	public function plugins_api_filter( $_data, $_action = '', $_args = null ) {
		...
		if ( is_object( $_data ) && ! isset( $_data->plugin ) ) {
