...
class WPF_Drip {
	...
	public function update_contact( $contact_id, $data ) {
		...
		if ( ! empty( $result['status'] ) && 'active' !== $result['status'] ) {
			...
			wpf_log( 'notice', $user_id, sprintf( __( 'Person has unsubscribed from marketing. Updates may not have been saved. For more information, see <a href="%s" target="_blank">our documentation</a>.', 'wp-fusion' ), 'https://wpfusion.com/documentation/crm-specific-docs/inactive-people-in-drip/' ), array( 'source' => 'drip' ) );
