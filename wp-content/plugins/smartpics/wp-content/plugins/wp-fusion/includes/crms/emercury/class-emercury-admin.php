...
class WPF_Emercury_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['emercury_email'] = array(
			'title'   => __( 'Email', 'wp-fusion' ),
			'desc'    => __( 'Your Emercury CRM account email.', 'wp-fusion' ),
			'type'    => 'text',
			'section' => 'setup',
		);
		...
		$new_settings['emercury_key'] = array(
			...
			'desc'        => __( 'Your API key. You can generate an API key in the <a href="https://panel.emercury.net/#settings/developer/" target="_blank">Developer Settings</a> panel in your Emercury account.', 'wp-fusion' ),
			'section'     => 'setup',
			'class'       => 'api_key',
	...
	public function register_settings( $settings, $options ) {
		...
		$new_settings['emercury_list_header'] = array(
			'title'   => __( 'Emercury Lists', 'wp-fusion' ),
			'type'    => 'heading',
			'section' => 'main',
		);
		...
		$site_tracking['site_tracking_header'] = array(
			'title'   => __( 'Emercury Settings', 'wp-fusion' ),
			'type'    => 'heading',
			'section' => 'main',
		);
		...
		$site_tracking['site_tracking'] = array(
			...
			'desc'    => __( 'Enable <a target="_blank" href="http://help.emercury.net/en/articles/5121464-site-event-tracking-in-emercury">Emercury site tracking</a>.', 'wp-fusion' ),
			'type'    => 'checkbox',
			'section' => 'main',
		);
