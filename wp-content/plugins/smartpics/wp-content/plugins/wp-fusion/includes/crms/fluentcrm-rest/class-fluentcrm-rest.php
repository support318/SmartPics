			...
			if ( wp_remote_retrieve_response_code( $response ) > 204 ) {
				...
				if ( ! empty( $body->code ) ) {
					...
					if ( ! empty( json_decode( $body ) ) ) {
						...
						$message .= '. ' . __( 'No response was returned. You may need to <a href="https://wordpress.org/support/article/using-permalinks/#mod_rewrite-pretty-permalinks" target="_blank">enable pretty permalinks</a>.', 'wp-fusion' );
					}
