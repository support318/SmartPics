...
class WPF_Bento_Admin {
	...
	public function register_settings( $settings, $options ) {
		...
		$site_tracking['site_tracking_header'] = array(
			'title'   => __( 'Bento Settings', 'wp-fusion' ),
			'type'    => 'heading',
			'section' => 'main',
		);
		...
		$site_tracking['site_tracking'] = array(
			...
			'desc'    => __( 'Enable <a target="_blank" href="https://bentonow.com/docs/bento-js-sdk">Bento site tracking</a>.', 'wp-fusion' ),
			'type'    => 'checkbox',
			'section' => 'main',
		);
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['site_uuid'] = array(
			'title'   => __( 'Site Unique ID', 'wp-fusion' ),
			'desc'    => __( 'Your site unique ID can be found in your Bento account under the Settings &raquo; <strong>Site UUID</strong>.', 'wp-fusion' ),
			'type'    => 'text',
			'section' => 'setup',
		);
