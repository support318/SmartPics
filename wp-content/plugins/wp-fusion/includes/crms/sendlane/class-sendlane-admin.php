...
class WPF_Sendlane_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['sendlane_token'] = array(
			...
			'desc'        => __( 'You can create an access token for WP Fusion in the <a href="https://app.sendlane.com/api" target="_blank">API settings</a> of your Sendlane account.', 'wp-fusion' ),
			'type'        => 'api_validate',
			'section'     => 'setup',
