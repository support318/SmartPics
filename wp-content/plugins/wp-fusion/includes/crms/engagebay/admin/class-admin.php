...
class WPF_EngageBay_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['engagebay_domain'] = array(
			...
			'desc'    => __( 'Enter your EngageBay CRM account subdomain (not the full URL) needed for tracking.', 'wp-fusion' ),
			'type'    => 'text',
			'section' => 'setup',
		);
		...
		$new_settings['engagebay_key'] = array(
			...
			'desc'        => __( 'You can create a new API key in the API Info settings of your EngageBay account.', 'wp-fusion' ),
			'type'        => 'api_validate',
			'section'     => 'setup',
			'class'       => 'api_key',
	...
	public function register_settings( $settings, $options ) {
		...
		$site_tracking['site_tracking_header'] = array(
			'title'   => __( 'EngageBay Site Tracking', 'wp-fusion' ),
			'type'    => 'heading',
			'section' => 'main',
		);
		...
		$site_tracking['site_tracking'] = array(
			...
			'desc'    => __( 'Enable EngageBay site tracking scripts.', 'wp-fusion' ),
			'type'    => 'checkbox',
			'section' => 'main',
		);

		$site_tracking['site_tracking_acct'] = array(
			'title'   => __( 'JavaScript API Key', 'wp-fusion' ),
			'desc'    => __( 'Your JavaScript API Key ID can be found in the Tracking Code in your EngageBay account, under Admin Settings &raquo; API and Tracking Code. For example: <code>8g8fejferfqbi4g4mradq09373</code>', 'wp-fusion' ),
			'type'    => 'text',
			'section' => 'main',
		);
