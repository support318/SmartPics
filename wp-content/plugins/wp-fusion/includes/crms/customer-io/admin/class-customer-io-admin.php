...
class WPF_Customer_IO_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['customer_io_header'] = array(
			'title'   => __( 'Customer.io Configuration', 'wp-fusion' ),
			'type'    => 'heading',
			'section' => 'setup',
		);

		$new_settings[ "{$this->slug}_region" ] = array(
			'title'   => __( 'Account Region', 'wp-fusion' ),
			'desc'    => __( 'You can find your region by going to <a target="_blank" href="https://fly.customer.io/settings/privacy">this link</a> and checking your data center on the right sidebar.', 'wp-fusion' ),
			'type'    => 'select',
			'choices' => array(
				'us' => 'United States',
				'eu' => 'Europe',
		...
		$new_settings[ "{$this->slug}_api_key" ] = array(
			...
			'desc'    => __( 'You can create your API key for WP Fusion by going to <a target="_blank" href="https://fly.customer.io/settings/api_credentials?keyType=app">this link</a>.', 'wp-fusion' ),
			'section' => 'setup',
			'type'    => 'text',
		);

		$new_settings[ "{$this->slug}_site_id" ] = array(
			'title'   => __( 'Tracking Site ID', 'wp-fusion' ),
			'desc'    => __( 'You can get your site ID for WP Fusion by going to <a target="_blank" href="https://fly.customer.io/settings/api_credentials?keyType=tracking">this link</a>.', 'wp-fusion' ),
			'section' => 'setup',
			'type'    => 'text',
		);

		$new_settings[ "{$this->slug}_tracking_api_key" ] = array(
			'title'       => __( 'Tracking API Key', 'wp-fusion' ),
			'desc'        => __( 'You can get your tracking API key for WP Fusion by going to <a target="_blank" href="https://fly.customer.io/settings/api_credentials?keyType=tracking">this link</a>.', 'wp-fusion' ),
			'type'        => 'api_validate',
			'section'     => 'setup',
			'class'       => 'api_key',
	...
	public function register_settings( $settings, $options ) {
		...
		$site_tracking['site_tracking_header'] = array(
			'title'   => __( 'Customer.io Settings', 'wp-fusion' ),
			'type'    => 'heading',
			'section' => 'main',
		);
