...
class WPF_Intercom_Admin {
	...
	public function register_settings( $settings, $options ) {
		...
		$site_tracking['site_tracking_header'] = array(
			'title'   => __( 'Intercom Site Tracking', 'wp-fusion' ),
			'type'    => 'heading',
			'section' => 'main',
		);
		...
		$site_tracking['site_tracking'] = array(
			...
			'desc'    => __( 'Enable <a target="_blank" href="https://wpfusion.com/documentation/tutorials/site-tracking-scripts/#intercom">Intercom site tracking scripts</a>.', 'wp-fusion' ),
			'type'    => 'checkbox',
			'section' => 'main',
		);
	...
	public function add_default_fields( $options ) {
		...
		if ( $options['connection_configured'] == true ) {
			...
			require_once __DIR__ . '/intercom-fields.php';
