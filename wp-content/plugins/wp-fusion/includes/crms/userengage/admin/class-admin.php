...
class WPF_UserEngage_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['userengage_header'] = array(
			'title'   => __( 'User.com Configuration', 'wp-fusion' ),
			'std'     => 0,
			'type'    => 'heading',
			'section' => 'setup',
		);
		...
		$new_settings['userengage_domain'] = array(
			'title'   => __( 'App Subdomain', 'wp-fusion' ),
			'desc'    => __( 'Enter the subdomain for your User.com account. For example if your app URL is <code>https://verygoodplugins.user.com</code>, your app subdomain would be <code>verygoodplugins</code>.', 'wp-fusion' ),
			'std'     => '',
			'type'    => 'text',
			'section' => 'setup',
		);
		...
		$new_settings['userengage_key'] = array(
			...
			'desc'        => __( 'You can find your Public API key in your UserEngage account under Settings &raquo; App Settings &raquo; Advanced &raquo; Public REST API keys.', 'wp-fusion' ),
			'type'        => 'api_validate',
			'section'     => 'setup',
			'class'       => 'api_key',
