...
class WPF_ConvertKit_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['ck_secret'] = array(
			...
			'desc'        => __( 'Enter the API Key and API Secret for your ConvertKit account (you can find your API keys in the <a href="https://app.convertkit.com/account_settings/advanced_settings" target="_blank">ConvertKit Account</a> page).', 'wp-fusion' ),
			'type'        => 'api_validate',
			'section'     => 'setup',
			'class'       => 'api_key',
