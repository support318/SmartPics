...
class WPF_Growmatik_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['growmatik_api_key'] = array(
			...
			'desc'    => __( 'Enter your ConvesioConvert API key. You can generate one in the <em>Site settings > Integrations > API</em>.', 'wp-fusion' ),
			'type'    => 'text',
			'section' => 'setup',
		);
		...
		$new_settings['growmatik_api_secret'] = array(
			...
			'desc'        => __( 'Enter your ConvesioConvert API Secret. You can generate one in the <em>Site settings > Integrations > API</em>.', 'wp-fusion' ),
			'type'        => 'api_validate',
			'section'     => 'setup',
			'class'       => 'api_key',
