...
class WPF_Groundhogg_REST_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['groundhogg_rest_url'] = array(
			...
			'section' => 'setup',
			'class'   => 'wp-rest-url',
			'desc'    => __( 'Enter the URL to your website where Groundhogg is installed (must be https://)', 'wp-fusion' ),
		);
		...
		$new_settings['groundhogg_rest_url']['desc'] .= '<br /><br /><a id="groundhogg_rest-auth-btn" class="' . esc_attr( $class ) . '" href="' . esc_url( $href ) . '">' . __( 'Authorize with Groundhogg', 'wp-fusion' ) . '</a>';
		$new_settings['groundhogg_rest_url']['desc'] .= '<span class="description">' . __( 'You can click the Authorize button to be taken to the Groundhogg site and generate an application password automatically, or enter your application credentials manually below.', 'wp-fusion' ) . '</span>';
