...
class WPF_Omnisend_Admin {
	...
	public function register_settings( $settings, $options ) {
		...
		$site_tracking['site_tracking_header'] = array(
			'title'   => __( 'Omnisend Settings', 'wp-fusion' ),
			'type'    => 'heading',
			'section' => 'main',
		);
		...
		$site_tracking['site_tracking'] = array(
			...
			'desc'    => __( 'Enable <a target="_blank" href="https://wpfusion.com/documentation/tutorials/site-tracking-scripts/#omnisend">Omnisend site tracking</a>.', 'wp-fusion' ),
			'type'    => 'checkbox',
		...
		$site_tracking['omnisend_brand_id'] = array(
			'title'   => __( 'Brand ID', 'wp-fusion' ),
			'desc'    => __( '<a target="_blank" href="https://support.omnisend.com/en/articles/2854729-omnisend-account-and-store-settings#connected-store">Find Your Brand ID</a>.', 'wp-fusion' ),
			'type'    => 'text',
			'section' => 'main',
		);
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings[ "{$this->slug}_api_key" ] = array(
			...
			'desc'        => __( 'You can generate an API key for WP Fusion by going <a target="_blank" href="https://app.omnisend.com/integrations/api-keys">this link</a>.', 'wp-fusion' ),
			'type'        => 'api_validate',
			'section'     => 'setup',
			'class'       => 'api_key',
