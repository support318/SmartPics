...
class WPF_Encharge_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['encharge_key'] = array(
			...
			'desc'        => __( 'Your API key, you can get it from <a target="_blank" href="https://app.encharge.io/account/info">here</a>.', 'wp-fusion' ),
			'section'     => 'setup',
			'class'       => 'api_key',
	...
	public function register_settings( $settings, $options ) {
		...
		$site_tracking['site_tracking_header'] = array(
			'title'   => __( 'Encharge Settings', 'wp-fusion' ),
			'type'    => 'heading',
			'section' => 'main',
		);
		...
		$site_tracking['site_tracking'] = array(
			...
			'desc'    => __( 'Enable <a target="_blank" href="https://app.encharge.io/settings/site-tracking">Encharge site tracking</a>.', 'wp-fusion' ),
			'type'    => 'checkbox',
			'section' => 'main',
		);

		$site_tracking['site_tracking_write_key'] = array(
			'title'   => __( 'Write Key', 'wp-fusion' ),
			'desc'    => __( 'Your JavaScript Write Key, it can be found <a target="_blank" href="https://app.encharge.io/account/info">here</a>', 'wp-fusion' ),
			'type'    => 'text',
			'section' => 'main',
		);
