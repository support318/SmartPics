...
class WPF_Drip_Admin {
	...
	public function filter_options( $options ) {
		...
		$options['inactive'] = __( '(Inactive in Drip)', 'wp-fusion' );
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['drip_account'] = array(
			...
			'desc'    => __( 'Enter the Account ID for your Drip account (find it under Settings > Account > General Info).', 'wp-fusion' ),
			'type'    => 'text',
			'section' => 'setup',
		);
	...
	public function register_settings( $settings, $options ) {
		...
		$site_tracking['site_tracking'] = array(
			...
			'desc'    => __( 'Enable <a target="_blank" href="https://wpfusion.com/documentation/tutorials/site-tracking-scripts/#drip">Drip site tracking</a>.', 'wp-fusion' ),
			'type'    => 'checkbox',
			'section' => 'main',
		);
